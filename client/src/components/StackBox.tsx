    ...
    <Grid container spacing={1}>
      <Grid container className={classes.column} item xs={4} spacing={3}>
        ...
        <Box className={classes.flex}>
          ...
          <Typography variant="subtitle1">
            ...
            track of values/errors/visited fields
          </Typography>
        </Box>
        <Box className={classes.flex}>
          ...
          <Typography variant="subtitle1">
            Object-relational database system that has earned it a strong
      ...
      <Grid container className={classes.column} item xs={4} spacing={3}>
        <Box className={classes.flex}>
          ...
          <Typography variant="subtitle1">
            Redux helps write applications that behave consistently, run in
        ...
        <Box className={classes.flex}>
          ...
          <Typography variant="subtitle1">
            ...
            Define a schema, transform a value to match, validate the shape of
            an existing value, or both.
          </Typography>
        </Box>
      </Grid>
      {/* ----------------------------------- */}
      <Grid container className={classes.column} item xs={4} spacing={3}>
        <Box className={classes.flex}>
          <Typography variant="body1" className={classes.mimicIcon}>
            TS
          </Typography>
        ...
        <Box className={classes.flex}>
          ...
          <Typography variant="subtitle1">
            Docker created the industry standard for containers, so they could
